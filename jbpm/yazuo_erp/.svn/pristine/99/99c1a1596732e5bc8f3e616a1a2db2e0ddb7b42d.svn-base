...
public class RefectUtils
{
	/**
	 * 
	 *根据属性的名字，以及class对象获得Method对象的getMethod.<br/>
	 *
	 * User: huijun.zheng<br/>
	 * Date: 2013-12-16<br/>
	 * Time: 上午11:44:22<br/>
...
//			e.printStackTrace();
	...
	/**
	 * 
	 *根据属性的名字，以及class对象获得Method对象的setMethod.<br/>
	 *
	 * User: huijun.zheng<br/>
	 * Date: 2013-12-16<br/>
	 * Time: 上午11:46:50<br/>
...
//			e.printStackTrace();
	 ...
	 *
	 * @param clazz
	 * @param isCamelFormat 是否转换为驼峰式写法，并首字母转换为小写，true是，false,否
	 * @return<br/>
	 */

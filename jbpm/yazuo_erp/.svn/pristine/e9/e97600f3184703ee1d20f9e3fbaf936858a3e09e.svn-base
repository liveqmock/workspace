...
public class FesOpenCardApplicationDtlVO implements java.io.Serializable {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("Id", getId())
				.append("ApplicationId", getApplicationId()).append("CardName", getCardName())
				.append("CardAmount", getCardAmount()).append("ValidityTerm", getValidityTerm())
				.append("IsContainFour", getIsContainFour()).append("IsContainSeven", getIsContainSeven())
				.append("Remark", getRemark()).append("InsertBy", getInsertBy()).append("InsertTime", getInsertTime()).toString();
	}

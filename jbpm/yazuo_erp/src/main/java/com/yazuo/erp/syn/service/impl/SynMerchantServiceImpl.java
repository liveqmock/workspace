...
public class SynMerchantServiceImpl implements SynMerchantService {
	...
	/**
	 * @Title getSynMerchantInfo
	 * @Description
	 * @param merchantName
	 * @return
	 * @see com.yazuo.erp.syn.service.SynMerchantService#getSynMerchantInfo(java.lang.String)
	 */
	@Override
	 ...
	 */
	@Override
	@Cacheable(value="merchantCache", key="'getComplexSynMerchants'+ #inputMap['pageNumber'] + #inputMap['userId']+ #inputMap['merchantName']")
...
//        merchantInfo.put("thirdparty_merchant_no", merchant.getThirdpartyMerchantNo());
	...
	@Override
	public JsonResult uploadCommonMethod(MultipartFile myfile, String realPath, Object object, String flag,

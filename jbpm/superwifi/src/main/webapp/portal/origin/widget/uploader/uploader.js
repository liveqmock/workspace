        ...
        var vmodel = avalon.define(data.uploaderId, function (vm) {
            ...
            vm.$init = function () {
                ...
                $('#' + uploaderId).uploadify(_.extend({
                    ...
                    "onFallback": function () {
                        elEl.width('auto').html('<span class="no-flash-player-tip">上传按钮暂不可使用，请点击<a href="http://get.adobe.com/cn/flashplayer/otherversions/" target="_blank">安装FLASH插件</a>，后重新启动ERP程序</span>');
                    }
                }, opts.uploadifyOpts, {
                    "onSelect": function () {

 ...
 * 添加工作计划
 */
define(['avalon', 'util', 'moment', 'json', '../../../widget/form/form', '../../../widget/form/select', '../../../widget/uploader/uploader', '../../../widget/calendar/calendar', '../../../module/address/address'], function (avalon, util, moment, JSON) {
     var win = this,
        erp = win.erp,
        pageMod = {};
    _.extend(pageMod, {
            ...
            var pageVm = avalon.define(pageName, function (vm) {
                ...
                vm.$assignerOpts = {
                    ...
                    "onSelect": function (selectedValue) {
                        ...
                        //设置商户联系人数据
                        if (selectedValue > 0 && projectVm.selectedValue > 0) {
                            vm.updateContactByProject(projectVm.selectedValue, selectedValue);
                        } else {

...
//		this("127.0.0.1");
	...
	public ElasticSearchHandler(String ipAddress) {
		 ...
		 */
//		1, The TransportClient connects remotely to an elasticsearch cluster using the transport module. It does not join the cluster,
		client = new TransportClient().addTransportAddress(new InetSocketTransportAddress(ipAddress, 9300));
//		2. Node Clientedit : Instantiating a node based client is the simplest way to get a Client that can execute operations against elasticsearch.

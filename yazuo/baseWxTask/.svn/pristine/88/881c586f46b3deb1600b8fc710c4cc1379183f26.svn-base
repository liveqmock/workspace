...
public class SynHealthDegreeVO implements java.io.Serializable {
	...
	public SynHealthDegreeVO(java.lang.Integer id) {
		this.id = id;
	}
	...
	public void setHealthDegree(java.math.BigDecimal healthDegree) {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("Id", getId())
				.append("MerchantId", getMerchantId()).append("TargetType", getTargetType())
				.append("TargetValue", getTargetValue()).append("ActualValue", getActualValue())
				.append("HealthDegree", getHealthDegree()).append("ReportTime", getReportTime())
	...
	public boolean equals(Object obj) {
		if (obj instanceof SynHealthDegreeVO == false)
			return false;
		if (this == obj)
			return true;

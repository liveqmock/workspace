...
public class FesPlanVO implements java.io.Serializable {
	...
	public FesPlanVO(java.lang.Integer id) {
		this.id = id;
	}
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("Id", getId()).append("UserId", getUserId())
				.append("MerchantId", getMerchantId()).append("Title", getTitle()).append("Description", getDescription())
				.append("StartTime", getStartTime()).append("EndTime", getEndTime()).append("Explanation", getExplanation())
				.append("IsRemind", getIsRemind()).append("RemindTime", getRemindTime()).append("IsSendSms", getIsSendSms())
				.append("Sponsor", getSponsor()).append("PlansSource", getPlansSource()).append("Status", getStatus())
				.append("IsEnable", getIsEnable()).append("Remark", getRemark()).append("InsertBy", getInsertBy())
	...
	public boolean equals(Object obj) {
		if (obj instanceof FesPlanVO == false)
			return false;
		if (this == obj)
			return true;

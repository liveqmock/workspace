 ...
 * @date
 */
public class SysRemindVO implements java.io.Serializable {
	...
	public static final String ALIAS_ITEM_TYPE = "提醒事项类型";
	public static final String ALIAS_ITEM_CONTENT = "提醒事项内容";
	public static final String ALIAS_ITEM_STATUS = "提醒事项状态";
	public static final String ALIAS_PROCESS_ID = "上线流程ID";
	...
	private java.lang.String itemType; // "提醒事项类型";
	private java.lang.String itemContent; // "提醒事项内容";
	private java.lang.String itemStatus; // "提醒事项状态";
	private java.lang.Integer processId; // "上线流程ID";
	...
	public SysRemindVO(java.lang.Integer id) {
		this.id = id;
	}
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("Id", getId()).append("UserId", getUserId())
				.append("MerchantId", getMerchantId()).append("PriorityLevelType", getPriorityLevelType())
				.append("ItemType", getItemType()).append("ItemContent", getItemContent()).append("ItemStatus", getItemStatus())
				.append("ProcessId", getProcessId()).append("Remark", getRemark()).append("IsEnable", getIsEnable())
	...
	public boolean equals(Object obj) {
		if (obj instanceof SysRemindVO == false)
			return false;
		if (this == obj)
			return true;
		SysRemindVO other = (SysRemindVO) obj;

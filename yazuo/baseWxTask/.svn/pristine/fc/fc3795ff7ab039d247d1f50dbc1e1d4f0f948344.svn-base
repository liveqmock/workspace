 ...
 */
public class SynHealthDegreeUpdateTask extends BaseTask {
	@Resource
	...
	public void execute1(Map params) {
		...
		try {
			synHealthDegreeService.batchUpdateSynHealthDegreeByIndexId(indexId);
			synHealthDegreeService.batchUpdateCurrentMonthSynHealthDegreeByIndexId(indexId);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

 ...
 * @date
 */
public class SysUserMerchantVO implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;

	// alias
	public static final String TABLE_ALIAS = "SysUserMerchant";
	...
	public SysUserMerchantVO() {
	}

	public SysUserMerchantVO(java.lang.Integer id) {
		this.id = id;
	}
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("Id", getId()).append("UserId", getUserId())
				.append("MerchantId", getMerchantId()).append("InsertBy", getInsertBy()).append("InsertTime", getInsertTime())
				.toString();
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof SysUserMerchantVO == false)
			return false;
		if (this == obj)
			return true;
		SysUserMerchantVO other = (SysUserMerchantVO) obj;

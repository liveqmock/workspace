...
public class SynMerchantVO implements java.io.Serializable {
	...
	public SynMerchantVO(java.lang.Integer merchantId) {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("MerchantId", getMerchantId())
				...
				.append("BrandId", getBrandId()).append("ThirdpartyMerchantNo", getThirdpartyMerchantNo())
				.append("ServiceYear", getServiceYear()).append("FreeMonth", getFreeMonth())
				.append("ServiceStartTime", getServiceStartTime()).append("ServiceEndTime", getServiceEndTime())
				.append("MerchantStatus", getMerchantStatus()).append("UpdateTime", getUpdateTime()).toString();
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof SynMerchantVO == false)
			return false;
		if (this == obj)
			return true;

...
public class UrlUtil {
	...
	public static String getImageUrl(String arg0,String arg1,String arg2){
		String imageUrl = "";
		try {
//			String conf = UrlUtil.class.getClassLoader().getResource("fdht_yazuo.conf").getPath();;
//			org.csource.fastdht.ClientGlobal.init(conf);
//			org.csource.fastdht.ClientGlobal.g_server_group.print();
			FastDHTClient client = new FastDHTClient(false);
			try {

				KeyInfo keyInfo = new KeyInfo(arg0, arg1, arg2);
				imageUrl =  client.get(keyInfo);

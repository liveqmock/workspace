...
basedir = "/home/song/workspace/yazuo/yazuo_erp/src/main/java/com/yazuo/erp" 
...
#    spam = pyperclip.paste()
    ...
    try:
         ...
         pyperclip.copy(str(all_the_text).encode('utf-8'))
    finally:
        file_object.close()
...
#    source_file = '/home/song/temp/test_interface.js'
    source_file = '/share/测试文件.js'
#    outFile = '/share/out.txt'
    outFile = 'out.txt'

 ...
 * 添加工作计划
 */
define(['avalon', 'util', 'moment', 'json', '../../../asset/events', '../../../widget/form/form', '../../../widget/form/select', '../../../widget/autocomplete/autocomplete.js', '../../../widget/uploader/uploader', '../../../widget/calendar/calendar', '../../../module/address/address'], function (avalon, util, moment, JSON, Events) {
    var win = this,
        erp = win.erp,
        pageMod = {},
                            ...
                            pageVm.updateContactByProject(data.merchant_id, function () {
                                ...
                                avalon.nextTick(function () {
                                    if (data.plan_item_type == "1") {
                                        planItemTypeVm.disabled = true;
                                        projectVm.disabled = true;
                                    } else {
                                        planItemTypeVm.disabled = false;
                                        projectVm.disabled = false;
                ...
                util.c2s({
                    ...
                    "success": function (responseData) {
                        ...
                        if (responseData.flag) {
                            ...
                            projectVm.getSelectVm().setOptions([{
                                "text": "其它",
                                "value": 0
                            }], -1);

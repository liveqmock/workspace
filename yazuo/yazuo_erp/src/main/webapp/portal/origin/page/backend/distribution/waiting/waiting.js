    ...
    _.extend(pageMod, {
        ...
        "$init": function (pageEl, pageName, routeData) {
            ...
            var pageVm = avalon.define(pageName, function (vm) {
                ...
                /*商户回调end*/
                /*list*/
                updateList({"merchantId": pageVm.merchantId, "userId": loginUserData.id,"resourceRemark":"end_delivery_service", "itemStatus": pageVm.itemStatus}, "fesOnlineProcess/listFesOnlineProcesss.do", listWaiting);

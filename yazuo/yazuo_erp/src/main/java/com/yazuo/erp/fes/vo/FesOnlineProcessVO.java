...
public class FesOnlineProcessVO implements java.io.Serializable{
	...
	private String itemStatus;//待办事项状态 0:未完成，1:已完成
	private String hasCardReq="0";//是否已经存在开卡申请 0:不存在, 1:存在
	//columns END

	public String getHasCardReq() {
		return hasCardReq;
	}

	public void setHasCardReq(String hasCardReq) {
		this.hasCardReq = hasCardReq;
	}

...
public interface FesPlanService {
	 ...
	 * @throws
	 */
	void checkCompleteMonthlyPlan(Integer userId, Integer planId, Integer merchantId, String planItemType, Date startTime);
     ...
     * @throws
     */
    void checkCreateMonthlyPlan(String planItemType, Integer userId, Integer merchantId, Integer planId, Date startTime);
     ...
     * @throws
     */
    void checkUserMerchant(Integer userId, Integer merchantId, String planItemType);
}

...
public class FesStowageVO implements java.io.Serializable{
	...
	private Map<String, Object> dicRowLogisticComp;  //数据字典行 快递公司
	public Map<String, Object> getDicRowLogisticComp() {
		return dicRowLogisticComp;
	}

	public void setDicRowLogisticComp(Map<String, Object> dicRowLogisticComp) {
		this.dicRowLogisticComp = dicRowLogisticComp;
	}

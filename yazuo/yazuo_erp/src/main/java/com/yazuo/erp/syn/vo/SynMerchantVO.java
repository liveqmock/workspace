...
public class SynMerchantVO implements java.io.Serializable{
	...
	private java.lang.String merchantStatus; //"上线状态";0-未上线1-已上线2-商户调研3-待分配前端顾问
	private java.util.Date updateTime; //"最后修改时间";
	private java.lang.Integer attachmentId; //"附件ID";
	private Integer storeId;//门店ID

	private java.lang.Integer inputUserId; //前端负责人ID;
	private Integer salesId;//销售负责人ID

	private List<Map<String,Object>> salesUsers;//销售负责人列表
	private List<Map<String,Object>> frontEndUsers;//前端负责人列表
	private String merchantStatusText;//上线状态文本
	private String isAment;//标识是否为一键上线查询

	private String salesName;//销售用户名
	private String frontEndUserName;//前端用户名
	...
	public String getFrontEndUserName() {
		return frontEndUserName;
	}

	public void setFrontEndUserName(String frontEndUserName) {
		this.frontEndUserName = frontEndUserName;
	}

	public String getIsAment() {
		return isAment;
	}

	public void setIsAment(String isAment) {
		this.isAment = isAment;
	}
	...
	public List<Map<String, Object>> getSalesUsers() {
		return salesUsers;
	}

	public void setSalesUsers(List<Map<String, Object>> salesUsers) {
		this.salesUsers = salesUsers;
	}

	public List<Map<String, Object>> getFrontEndUsers() {
		return frontEndUsers;
	}

	public void setFrontEndUsers(List<Map<String, Object>> frontEndUsers) {

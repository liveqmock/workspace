 ...
 * @date
 */
public interface SynMembershipCardService {
	 ...
	 * 返回商户对应的会员卡信息
	 */
	List<Map<String, Object>> getSynMembershipCardInfo(Integer brandId, int pageNumber, int pageSize);

	long getSynMembershipCardCount(Integer brandId);
}

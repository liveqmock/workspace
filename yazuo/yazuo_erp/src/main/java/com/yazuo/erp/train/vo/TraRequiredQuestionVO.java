...
public class TraRequiredQuestionVO implements java.io.Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "TraRequiredQuestion";
	...
	public boolean equals(Object obj) {
		if(obj instanceof TraRequiredQuestionVO == false) return false;
		if(this == obj) return true;
		TraRequiredQuestionVO other = (TraRequiredQuestionVO)obj;

...
public interface SysAttachmentService{
   ...
   /**
	 ...
	 * @return
	 */
	SysAttachmentVO saveAttachmentAndFile(MultipartFile file, String module, String type, String attachmentType, Integer userId, String uploadRoot);

	/**
	 * 删除附件
	 * @param Id
	 */
	void deleteSysAttachmentAndFile(String downloadRoot,Integer Id);

...
public class SysUserVO implements java.io.Serializable {
	...
	private SysPositionVO position;//职位
	...
	private String isSeledted;//判断是否选中  下拉列表框调用

	private java.lang.Integer pageNumber;
	private java.lang.Integer pageSize; 
	private String resources;//用户拥有的资源 //"规则,回访,续卡,续短信,新需求,数据提取,投诉,培训,设备配送"
	...
	public String getIsSeledted() {
		return isSeledted;
	}

	public void setIsSeledted(String isSeledted) {
		this.isSeledted = isSeledted;
	}

...
define(["avalon", "util"], function(avalon, util) {
    ...
    var formInit = function () {
        ...
        $('body').on('focus', '.input-text,textarea', function () {
            ...
            //只有在disabled状态才不显示关闭按钮
            if (meEl.prop('disabled') || meEl.attr('withemptyicon') === "no") {
                return;
            }

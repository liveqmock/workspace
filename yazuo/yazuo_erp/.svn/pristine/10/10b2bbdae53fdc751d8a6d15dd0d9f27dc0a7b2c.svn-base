...
public class SysGroupServiceImpl implements SysGroupService {
    ...
    @Override
    public List<SysGroupVO> getAllSysGroupVOs() {
        return this.sysGroupDao.getAllSysGroupVOs();
    }
	...
	@Override
	public List<Integer> getUserIdsByGroupIds(List<Integer> groupIds) {
		return this.sysGroupDao.getUserIdsByGroupIds(groupIds);
	}

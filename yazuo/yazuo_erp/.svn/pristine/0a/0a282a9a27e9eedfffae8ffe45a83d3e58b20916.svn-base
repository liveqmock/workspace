    ...
    _.extend(pageMod, {
        ...
        "$init": function (pageEl, pageName, routeData) {
            ...
            var pageVm = avalon.define(pageName, function (vm) {
                ...
                vm.merchantName = '';
                vm.pageStatus= 1;
                vm.upLineType = vm.itemStatus=='0'?1:2;//上线回访操作状态（1是进行，2是完成）
                vm.activeType = vm.itemStatus=='0'?1:2;//营销活动操作状态（1是进行，2是完成）
            ...
            /*商户回调end*/
            /*代办事项列表*/
            updateList({"merchantId":pageVm.merchantId, "itemStatus": pageVm.itemStatus},"fesOnlineProcess/listFesOnlineProcesssAfterOnline.do",waitingList);

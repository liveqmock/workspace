...
public class SysUserServiceImpl implements SysUserService {
	...
	@Override
	public List<SysUserVO> getUsersByIds(List<Integer> userIds) {
        if (CollectionUtils.isNotEmpty(userIds)) {
            return this.sysUserDao.getUsersByIds(userIds);
        } else {
    ...
    public List<SysUserVO> getSysUserList() {
        return this.sysUserDao.getSysUserList();
    }

	@Override
	public List<SysUserVO> getAllUsersByPositionIds(List<Integer> positionIds) {
		return this.sysUserDao.getAllUsersByPositionIds(positionIds);
	}
	 ...
	 */
	@Override
	public List<Map<String, Object>> getUsersByResourceCode(SysResourceVO sysResourceVO) {
		List<SysUserVO> allUsersByResourceCode = this.sysResourceDao.getAllUsersByResourceCode(sysResourceVO);
		List<Map<String, Object>> list = new ArrayList<Map<String,Object>>();
		for (SysUserVO sysUserVO : allUsersByResourceCode) {
			Map<String, Object> newMap = new HashMap<String, Object>();
			newMap.put("value", sysUserVO.getId());
			newMap.put("text", sysUserVO.getUserName());
			newMap.put("mobilePhone", sysUserVO.getTel());
			list.add(newMap);
		}
		return list;
	}
	...
	@Override
	public Page<SysUserVO> getComplexSysUsersForBes(Map<String, Object> paramMap) {
		return sysUserDao.getComplexSysUsersForBes(paramMap);
	}
}

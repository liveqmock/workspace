...
public class BesRequirementVO implements java.io.Serializable{
	...
	public static final String ALIAS_TYPE_OF_KEY = "标识外键的类型";
	public static final String ALIAS_FES_PLAN_ID = "工作计划外键";
	public static final String ALIAS_PROCESS_STATUS = "流程状态";
	public static final String ALIAS_IS_REMIND = "是否开启提醒";
	public static final String ALIAS_NODE_LAST_TIME = "节点时间";
	...
	public static final String COLUMN_TYPE_OF_KEY = "typeOfKey";
	public static final String COLUMN_FES_PLAN_ID = "fesPlanId";
	public static final String COLUMN_PROCESS_STATUS = "processStatus";
	public static final String COLUMN_IS_REMIND = "isRemind";
	public static final String COLUMN_NODE_LAST_TIME = "nodeLastTime";
	...
	private java.lang.String resourceRemark; //"需求类型"; 参照权限树
	private java.lang.String resourceExtraRemark; //"其他需求类型";参照权限树
	...
	private java.lang.String status; //"状态"; 1:未指派  2:未完成 3:已完成
	...
	private java.lang.String typeOfKey; //"标识外键的类型";
	private java.lang.Integer fesPlanId; //"工作计划外键";
	private java.lang.String processStatus; //"流程状态";
	private java.lang.String isRemind; //"是否开启提醒" 0:关闭; 1:开启;
	private java.util.Date nodeLastTime; //"节点时间";
	//columns END
	//others
	...
	private Map<String, Object> dicRowProcessStatus;//流程状态
	...
	private String fesUserTel;//前端负责人电话
	...
	public Map<String, Object> getDicRowProcessStatus() {
		return dicRowProcessStatus;
	}

	public void setDicRowProcessStatus(Map<String, Object> dicRowProcessStatus) {
		this.dicRowProcessStatus = dicRowProcessStatus;
	}
    ...
    public String getFesUserTel() {
        return fesUserTel;
    }

    public void setFesUserTel(String fesUserTel) {
        this.fesUserTel = fesUserTel;
    }
	...
	public void setTypeOfKey(java.lang.String value) {
		this.typeOfKey = value;
	}
	
	public java.lang.String getTypeOfKey() {
		return this.typeOfKey;
	}
		
	public void setFesPlanId(java.lang.Integer value) {
		this.fesPlanId = value;
	}
	
	public java.lang.Integer getFesPlanId() {
		return this.fesPlanId;
	}
	...
	public void setIsRemind(java.lang.String value) {
		this.isRemind = value;
	}
	...
	public void setNodeLastTime(java.util.Date value) {
		this.nodeLastTime = value;
	}
	
	public java.util.Date getNodeLastTime() {
		return this.nodeLastTime;
	}
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("TypeOfKey",getTypeOfKey())
			.append("FesPlanId",getFesPlanId())
			.append("ProcessStatus",getProcessStatus())
			.append("IsRemind",getIsRemind())
			.append("NodeLastTime",getNodeLastTime())
			.toString();
	}

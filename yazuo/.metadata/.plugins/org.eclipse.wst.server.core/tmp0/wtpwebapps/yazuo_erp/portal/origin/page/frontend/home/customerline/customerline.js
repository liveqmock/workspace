    ...
    _.extend(pageMod, {
        ...
        "$init": function (pageEl, pageName, routeData) {
            ...
            var pageVm = avalon.define(pageName, function (vm) {
                ...
                vm.imgUrl = '';
                vm.upfile = '';
                vm.healthMonth = nowDate.getMonth()+1;//健康度月
                vm.healthYear = nowDate.getFullYear();//健康度年
                vm.promise = false;//权限
                ...
                var healthModel = function () {
                    ...
                    function healthDataCallBack() {
                        var nowDate = moment(moment().format('YYYY-M'))/1;
                        var selectedDate = moment(healthYear+'-'+healthMonth)/1;
                ...
                vm.addPutEmailModel = function () {
                    ...
                    pageVm.mailRequestData.mailTemplateId = id;
                    pageVm.mailRequestData.smsContent = smsContent;
                };
